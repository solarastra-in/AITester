  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/60 backdrop-blur-xs">
      <div className="flex h-full w-full max-w-2xl flex-col border-l border-[#1E2235] bg-[#0F111A] shadow-2xl">
        {/* Drawer Header */}
        <div className="flex items-center justify-between border-b border-[#1E2235] px-4 sm:px-6 py-3.5 sm:py-4">
          <div className="flex items-center gap-2 sm:gap-3 overflow-hidden">
            <span className="rounded bg-[#1A1D2B] px-2 py-1 font-mono text-xs font-bold text-emerald-400 border border-[#1E2235] shrink-0">
              {testCase.extId}
            </span>
            <span className={`rounded px-2 py-0.5 text-[11px] font-bold uppercase shrink-0 ${
            ...
            <span className="text-xs text-slate-400 truncate">{testCase.category}</span>
          </div>
          <button
            onClick={onClose}
            className="rounded-lg p-1.5 text-slate-400 hover:bg-[#131622] hover:text-white shrink-0"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
        ...
        <div className="border-b border-[#1E2235] bg-[#06070B]/40 px-4 sm:px-6 py-4">
          <h2 className="text-sm sm:text-base font-bold text-white leading-snug">{testCase.title}</h2>
            ...
            {!isManual ? (
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                <button
                  ...
                  disabled={isRunning}
                  className="flex items-center justify-center gap-1.5 rounded-xl border border-[#1E2235] bg-[#131622] px-3.5 py-2 text-xs font-semibold text-slate-200 transition hover:bg-[#1A1D2B] disabled:opacity-50 min-h-[38px] sm:min-h-0"
                ...
                <button
                  ...
                  disabled={isRunning}
                  className="flex items-center justify-center gap-1.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 px-4 py-2 text-xs font-bold text-slate-950 shadow-md shadow-emerald-500/20 transition hover:from-emerald-400 hover:to-teal-500 disabled:opacity-50 min-h-[38px] sm:min-h-0"
        ...
        {/* Tab navigation */}
        <div className="flex overflow-x-auto border-b border-[#1E2235] px-4 sm:px-6">
          {[
            ...
            <button
              ...
              className={`shrink-0 whitespace-nowrap border-b-2 px-3.5 sm:px-4 py-2.5 text-xs font-semibold transition ${
                activeTab === tab.id
