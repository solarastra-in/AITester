...
export const EngineSettingsModal: React.FC<EngineSettingsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 overflow-y-auto">
      <div className="relative w-full max-w-2xl rounded-2xl border border-[#1E2235] bg-[#0A0C14] shadow-2xl overflow-hidden my-6">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-[#1E2235] bg-[#0F111A] px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-base font-bold text-white">Verity API Engine Configuration</h3>
          ...
          <button
            type="button"
            onClick={onClose}
            className="rounded-lg p-1.5 text-slate-400 hover:bg-[#1E2235] hover:text-white transition"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
        ...
        {/* Footer */}
        <div className="flex items-center justify-between border-t border-[#1E2235] bg-[#0F111A] px-6 py-4">
          <button
            type="button"
            onClick={() => handleApplyPreset(DEFAULT_CLOUD_RUN_ENGINE_URL)}
            className="text-xs text-slate-400 hover:text-emerald-300 transition underline underline-offset-2"
          >
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={handleSave}
              className="flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 px-4 py-2 text-xs font-bold text-slate-950 shadow-md shadow-emerald-500/20 hover:from-emerald-400 hover:to-teal-500 transition"
            >
